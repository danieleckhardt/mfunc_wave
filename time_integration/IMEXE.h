...
{
    template<int dim>
    class ImexE : public TimeIntegrator<dim>
    {
        public:
            ImexE(FE_Q<dim>&  fe_macro, DoFHandler<dim>&  dof_handler_macro,AffineConstraints<double>& constraints_macro, 
       ...
       protected: 
        ...
        private:
            ...
            void assemble_system_V(const Vector<double>  &old_solution_macro_u, const Vector<double>& old_solution_macro_v, const double &time_macro);
    };
}
}
 #endif /* IMEXE_H_ */