#ifndef EXPMIDPOINT_H_
#define EXPMIDPOINT_H_
...
{
    template<int dim>
    class expMidpoint : public TimeIntegrator<dim>
    {
        public:
            expMidpoint(FE_Q<dim>&  fe_macro, DoFHandler<dim>&  dof_handler_macro,AffineConstraints<double>& constraints_macro, 
